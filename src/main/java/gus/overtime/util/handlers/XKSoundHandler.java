...
public class XKSoundHandler {
    ...
    public static SoundEvent DESAN;

    //TODO Give other sounds vars and add other sounds
    public XKSoundHandler() {
        ...
        //TODO Remove once test done
        DESAN = registerSound("desan");
    ...
    private SoundEvent registerSound(String name) {
        ResourceLocation location = new ResourceLocation(Overtime.MODID, name);

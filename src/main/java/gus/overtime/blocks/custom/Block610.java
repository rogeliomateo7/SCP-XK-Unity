...
import gus.overtime.util.handlers.XKConfigHandler;
...
import static gus.overtime.blocks.custom.Block610.Log610.FACING;
import static net.minecraft.block.BlockLog.LOG_AXIS;

public class Block610 extends XKBlock {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        switch (replaceBlock) {
            ...
            case LOG: {
                switch (axis) {
                    case 1:
                        block = BlockInit.SCP610LOG.getDefaultState().withProperty(FACING, EnumFacing.EAST);
                        break;
                    case 2:
                        block = BlockInit.SCP610LOG.getDefaultState().withProperty(FACING, EnumFacing.NORTH);
                        break;
                    default: 
                        block = BlockInit.SCP610LOG.getDefaultState().withProperty(FACING, EnumFacing.UP);
                        break;
                }
                break;
            }
